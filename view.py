...
if __name__ == "__main__":
    while True:
        ...
        if local == 1:
            ...
            cat = Controller.EstoqueController()
            while True:
            ...
            cat = Controller.FornecedorController()
            while True:
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    cat.relatorioPeriodo(dataInicio, dataTermino)

        elif local == 7:
            a = Controller.VendaController()
            a.relatorioProdutos()
        else:
            break